...
class App extends React.Component {
	...
	// Generally not recommended to do data loading inside of the constructor; Makes the code
	// clearer than having it spread across componentDidMount and constructor.
	//   constructor(props) {
	//     // We are borrowing functionality from react component base class; Must call super to make
	//  //sure that we are able to call the constructor function from the parent component
	...
	//   }
	// This is a shorter way of using JSX to initialize state; Doesn't use a constructor function.
	// Babel will translate it to a constructor function for us.
